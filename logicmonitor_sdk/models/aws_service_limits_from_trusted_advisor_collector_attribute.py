...
class AwsServiceLimitsFromTrustedAdvisorCollectorAttribute(CollectorAttribute):
    ...
    @property
    def name(self):
        """Gets the name of this AwsServiceLimitsFromTrustedAdvisorCollectorAttribute.  # noqa: E501


        :return: The name of this AwsServiceLimitsFromTrustedAdvisorCollectorAttribute.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AwsServiceLimitsFromTrustedAdvisorCollectorAttribute.


        :param name: The name of this AwsServiceLimitsFromTrustedAdvisorCollectorAttribute.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def aws_service_name(self):
        ...
        :return: The aws_service_name of this AwsServiceLimitsFromTrustedAdvisorCollectorAttribute.  # noqa: E501
        :rtype: str
        """
        return self._aws_service_name

    @aws_service_name.setter
    def aws_service_name(self, aws_service_name):
        """Sets the aws_service_name of this AwsServiceLimitsFromTrustedAdvisorCollectorAttribute.


        :param aws_service_name: The aws_service_name of this AwsServiceLimitsFromTrustedAdvisorCollectorAttribute.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AwsServiceLimitsFromTrustedAdvisorCollectorAttribute, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AwsServiceLimitsFromTrustedAdvisorCollectorAttribute):
            return False
