...
class WebsiteOverviewWidget(Widget):
    ...
    def __init__(self, last_updated_by=None, user_permission=None, dashboard_id=None, name=None, description=None, last_updated_on=None, theme=None, interval=None, id=None, type=None, timescale=None, website_name=None, website_id=None, geo_info=None, graph=None):  # noqa: E501
