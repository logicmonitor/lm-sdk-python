...
**metrics** | [**list[SDTInventoryMetric]**](SDTInventoryMetric.md) |  | [optional] 
**sdt_settings** | **str** | The sdt settings selected for the report | 
**user** | **str** | The user name selected for the report | [optional] 
