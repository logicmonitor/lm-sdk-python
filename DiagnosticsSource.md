...
**data_type** | **int** | The data type of diagnostics source, default is 0. The values can be  0: diagnostics source  1: raw ERI    | [optional] 
...
**source** | **str** | The diagnostics source | [optional] 
