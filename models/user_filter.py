...
class UserFilter(object):
    ...
    def __init__(self, api_only_user=None, email=None, enable2fa=None, first_name=None, last_name=None, role_assignment=None, status=None, username=None):  # noqa: E501
