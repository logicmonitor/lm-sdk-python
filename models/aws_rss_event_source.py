...
class AwsRssEventSource(EventSource):
    ...
    def __init__(self, alert_subject_template=None, alert_level=None, description=None, applies_to=None, technology=None, filters=None, version=None, collector=None, tags=None, alert_body_template=None, name=None, clear_after_ack=None, id=None, alert_effective_ival=None, group=None, schedule=None):  # noqa: E501
