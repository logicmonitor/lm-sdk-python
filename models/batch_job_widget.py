...
class BatchJobWidget(Widget):
    ...
    def __init__(self, dashboard_id=None, description=None, id=None, interval=None, last_updated_by=None, last_updated_on=None, name=None, theme=None, timescale=None, type=None, user_permission=None, batch_job_id=None, batch_job_name=None, device_display_name=None, group_display_name=None):  # noqa: E501
