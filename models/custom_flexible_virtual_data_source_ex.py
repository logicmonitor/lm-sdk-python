...
class CustomFlexibleVirtualDataSourceEx(object):
    ...
    def __init__(self, aggregate_function=None, consolidate_function=None, custom_graph_id=None, data_point_id=None, data_point_name=None, data_source_full_name=None, data_source_id=None, device_display_name=None, device_group_full_path=None, display=None, id=None, instance_name=None, name=None):  # noqa: E501
