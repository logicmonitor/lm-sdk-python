...
class RestDiagnosticSourceV4(object):
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["DATASOURCE", "EVENTSOURCE", "CONFIGSOURCE", "PROPERTYSOURCE", "DIAGNOSTICSOURCE", "REMEDIATIONSOURCE", "TOPOLOGYSOURCE", "JOBMONITOR", "APPLIESTO_FUNCTION", "SNMP_SYSOID_MAP", "LOGSOURCE"]  # noqa: E501
    ...
    def origin_status(self, origin_status):
        ...
        :type: str
        """
        allowed_values = ["CORE", "LM_ENDORSED", "COMMUNITY", "BETA", "DEPRECATED", "SECURITY_REVIEW"]  # noqa: E501
