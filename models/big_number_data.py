...
class BigNumberData(object):
    ...
    def __init__(self, bottom_label=None, color_level=None, error_message=None, position=None, right_label=None, rounding=None, use_comma_separators=None, value=None):  # noqa: E501
