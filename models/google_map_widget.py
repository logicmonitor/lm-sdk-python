...
class GoogleMapWidget(Widget):
    ...
    def __init__(self, dashboard_id=None, description=None, id=None, interval=None, last_updated_by=None, last_updated_on=None, name=None, theme=None, timescale=None, type=None, user_permission=None, ack_checked=None, display_critical_alert=None, display_error_alert=None, display_warn_alert=None, map_points=None, sdt_checked=None):  # noqa: E501
