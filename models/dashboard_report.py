...
class DashboardReport(ReportBase):
    ...
    def __init__(self, custom_report_type_id=None, custom_report_type_name=None, delivery=None, description=None, enable_view_as_other_user=None, format=None, group_id=None, id=None, last_generate_on=None, last_generate_pages=None, last_generate_size=None, lastmodify_user_id=None, lastmodify_user_name=None, name=None, recipients=None, report_link_num=None, schedule=None, schedule_timezone=None, type=None, user_permission=None, dashboard_group_full_path=None, dashboard_id=None, dashboard_name=None, date_range=None, display_link=None, display_name=None):  # noqa: E501
