...
class CellData(object):
    ...
    def __init__(self, alert_severity=None, alert_status=None, days_until_alert_list=None, forecast_day=None, instance_id=None, instance_name=None, value=None):  # noqa: E501
