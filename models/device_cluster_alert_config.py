...
class DeviceClusterAlertConfig(object):
    ...
    def __init__(self, min_alert_level=None, data_source_display_name=None, disable_alerting=None, data_point_description=None, count_by=None, data_point_name=None, data_source_id=None, data_point_id=None, device_group_id=None, id=None, suppress_ind_alert=None, threshold_type=None, alert_expr=None):  # noqa: E501
    ...
    def device_group_id(self):
        """Gets the device_group_id of this DeviceClusterAlertConfig.  # noqa: E501

        The id of the device group this cluster alert configuration belongs to  # noqa: E501

        :return: The device_group_id of this DeviceClusterAlertConfig.  # noqa: E501
        :rtype: int
        """
    ...
    def device_group_id(self, device_group_id):
        """Sets the device_group_id of this DeviceClusterAlertConfig.

        The id of the device group this cluster alert configuration belongs to  # noqa: E501

        :param device_group_id: The device_group_id of this DeviceClusterAlertConfig.  # noqa: E501
        :type: int
        """
