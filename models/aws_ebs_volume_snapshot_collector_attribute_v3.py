...
class AwsEbsVolumeSnapshotCollectorAttributeV3(CollectorAttribute):
    ...
    @property
    def name(self):
        """Gets the name of this AwsEbsVolumeSnapshotCollectorAttributeV3.  # noqa: E501

        data collector's name  # noqa: E501

        :return: The name of this AwsEbsVolumeSnapshotCollectorAttributeV3.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AwsEbsVolumeSnapshotCollectorAttributeV3.

        data collector's name  # noqa: E501

        :param name: The name of this AwsEbsVolumeSnapshotCollectorAttributeV3.  # noqa: E501
        :type: str
        """
        if name is None:
