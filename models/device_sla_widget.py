...
class DeviceSLAWidget(Widget):
    ...
    def __init__(self, last_updated_by=None, user_permission=None, dashboard_id=None, name=None, description=None, last_updated_on=None, theme=None, interval=None, id=None, type=None, timescale=None, calculation_method=None, days_in_week=None, display_type=None, top_x=None, timezone=None, bottom_label=None, display_percentage_bar=None, period_in_one_day=None, metrics=None, unmonitored_time_type=None, color_thresholds=None):  # noqa: E501
