...
class BatchScriptCollectorAttribute(CollectorAttribute):
    ...
    def __init__(self, groovy_script=None, script_type=None, windows_script=None, linux_cmdline=None, linux_script=None, windows_cmdline=None, *args, **kwargs):  # noqa: E501
