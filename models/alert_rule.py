...
class AlertRule(object):
    ...
    def __init__(self, datapoint=None, datasource=None, device_groups=None, devices=None, escalating_chain=None, escalating_chain_id=None, escalation_interval=None, id=None, instance=None, level_str=None, name=None, priority=None, suppress_alert_ack_sdt=None, suppress_alert_clear=None):  # noqa: E501
