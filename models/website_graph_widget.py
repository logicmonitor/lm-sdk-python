...
class WebsiteGraphWidget(Widget):
    ...
    def __init__(self, dashboard_id=None, description=None, id=None, interval=None, last_updated_by=None, last_updated_on=None, name=None, theme=None, timescale=None, type=None, user_permission=None, checkpoint_id=None, geo_info=None, graph=None, website_name=None):  # noqa: E501
