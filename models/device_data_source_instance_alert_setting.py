...
class DeviceDataSourceInstanceAlertSetting(object):
    ...
    def __init__(self, alert_clear_interval=None, alert_expr=None, alert_expr_note=None, alert_transition_interval=None, alerting_disabled_on=None, data_point_description=None, data_point_id=None, data_point_name=None, data_source_instance_alias=None, data_source_instance_id=None, device_group_full_path=None, device_group_id=None, disable_alerting=None, disable_dp_alert_host_groups=None, global_alert_expr=None, id=None, parent_device_group_alert_expr_list=None):  # noqa: E501
