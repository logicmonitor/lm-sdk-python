...
class DeviceGroupAlertThresholdInfo(object):
    ...
    def __init__(self, enable_anomaly_alert_generation=None, alert_for_no_data=None, user_permission=None, enable_anomaly_alert_suppression=None, group_id=None, alert_clear_transition_interval=None, alert_enabled=None, group_full_path=None, alert_expr=None, alert_transition_interval=None):  # noqa: E501
