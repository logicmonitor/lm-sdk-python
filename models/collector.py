...
class Collector(object):
    ...
    def __init__(self, ack_comment=None, acked=None, acked_by=None, acked_on=None, acked_on_local=None, arch=None, automatic_upgrade_info=None, backup_agent_id=None, build=None, can_downgrade=None, can_downgrade_reason=None, clear_sent=None, collector_conf=None, collector_device_id=None, collector_group_id=None, collector_group_name=None, collector_size=None, conf_version=None, created_on=None, created_on_local=None, custom_properties=None, description=None, ea=None, enable_fail_back=None, enable_fail_over_on_collector_device=None, escalating_chain_id=None, has_fail_over_device=None, hostname=None, id=None, in_sdt=None, is_down=None, last_sent_notification_on=None, last_sent_notification_on_local=None, need_auto_create_collector_device=None, netscan_version=None, next_recipient=None, next_upgrade_info=None, number_of_hosts=None, number_of_instances=None, number_of_websites=None, onetime_downgrade_info=None, onetime_upgrade_info=None, platform=None, predefined_config=None, previous_version=None, resend_ival=None, sbproxy_conf=None, specified_collector_device_group_id=None, status=None, suppress_alert_clear=None, up_time=None, updated_on=None, updated_on_local=None, user_change_on=None, user_change_on_local=None, user_permission=None, user_visible_hosts_num=None, user_visible_websites_num=None, watchdog_conf=None, watchdog_updated_on=None, watchdog_updated_on_local=None, website_conf=None, wrapper_conf=None):  # noqa: E501
