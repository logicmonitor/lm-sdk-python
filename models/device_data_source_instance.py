...
class DeviceDataSourceInstance(object):
    ...
    def __init__(self, auto_properties=None, custom_properties=None, data_source_id=None, data_source_type=None, description=None, device_data_source_id=None, device_display_name=None, device_id=None, disable_alerting=None, display_name=None, group_id=None, group_name=None, id=None, lock_description=None, name=None, stop_monitoring=None, system_properties=None, wild_value=None, wild_value2=None):  # noqa: E501
