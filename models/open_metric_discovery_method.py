...
class OpenMetricDiscoveryMethod(AutoDiscoveryMethod):
    ...
    def __init__(self, name=None, headers=None, metric_name=None, read_timeout=None, follow_redirect=None, connect_timeout=None, group_label=None, instance_label=None, instance_property_tags=None, url=None):  # noqa: E501
