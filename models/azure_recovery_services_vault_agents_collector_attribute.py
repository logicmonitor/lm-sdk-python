...
class AzureRecoveryServicesVaultAgentsCollectorAttribute(CollectorAttribute):
    ...
    @property
    def name(self):
        """Gets the name of this AzureRecoveryServicesVaultAgentsCollectorAttribute.  # noqa: E501

        The data collector's name  # noqa: E501

        :return: The name of this AzureRecoveryServicesVaultAgentsCollectorAttribute.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AzureRecoveryServicesVaultAgentsCollectorAttribute.

        The data collector's name  # noqa: E501

        :param name: The name of this AzureRecoveryServicesVaultAgentsCollectorAttribute.  # noqa: E501
        :type: str
        """
        if name is None:
