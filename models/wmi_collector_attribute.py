...
class WMICollectorAttribute(CollectorAttribute):
    ...
    def __init__(self, name=None, ip=None, method_inputs=None, method_name=None, namespace=None, query_class=None, query_index=None, query_value=None, target_path=None, type=None):  # noqa: E501
