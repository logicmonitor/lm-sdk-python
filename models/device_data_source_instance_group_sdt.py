...
class DeviceDataSourceInstanceGroupSDT(SDT):
    ...
    def __init__(self, admin=None, comment=None, duration=None, end_date_time=None, end_date_time_on_local=None, end_hour=None, end_minute=None, hour=None, id=None, is_effective=None, minute=None, month_day=None, sdt_type=None, start_date_time=None, start_date_time_on_local=None, timezone=None, type=None, week_day=None, week_of_month=None, data_source_name=None, device_data_source_id=None, device_data_source_instance_group_id=None, device_data_source_instance_group_name=None, device_display_name=None, device_id=None):  # noqa: E501
