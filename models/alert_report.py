...
class AlertReport(ReportBase):
    ...
    def __init__(self, custom_report_type_id=None, custom_report_type_name=None, delivery=None, description=None, enable_view_as_other_user=None, format=None, group_id=None, id=None, last_generate_on=None, last_generate_pages=None, last_generate_size=None, lastmodify_user_id=None, lastmodify_user_name=None, name=None, recipients=None, report_link_num=None, schedule=None, schedule_timezone=None, type=None, user_permission=None, ack_filter=None, active_only=None, chain=None, columns=None, data_point=None, data_source=None, data_source_instance_name=None, date_range=None, device_display_name=None, group_full_path=None, include_preexist=None, level=None, rule=None, sdt_filter=None, sorted_by=None, summary_only=None, timing=None):  # noqa: E501
