...
class NetAppAutoDiscoveryMethod(AutoDiscoveryMethod):
    ...
    def __init__(self, name=None, instance_description=None, instance_group_name=None, instance_locator=None, instance_name=None, instance_value=None, object=None, request=None, type=None):  # noqa: E501
