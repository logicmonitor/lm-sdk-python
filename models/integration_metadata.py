...
class IntegrationMetadata(object):
    ...
    def logic_module_type(self, logic_module_type):
        ...
        :type: str
        """
        allowed_values = ["DATASOURCE", "EVENTSOURCE", "JOBMONITOR", "APPLIESTO_FUNCTION", "SNMP_SYSOID_MAP", "PROPERTYSOURCE", "CONFIGSOURCE", "TOPOLOGYSOURCE", "LOGSOURCE", "DIAGNOSTICSOURCE", "REMEDIATIONSOURCE"]  # noqa: E501
