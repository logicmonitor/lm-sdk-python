...
class DeviceGroupData(object):
    ...
    def __init__(self, applies_to=None, aws_regions_info=None, azure_regions_info=None, description=None, full_path=None, gcp_regions_info=None, group_type=None, id=None, name=None, num_of_direct_devices=None, num_of_direct_sub_groups=None, num_of_hosts=None, user_permission=None):  # noqa: E501
