...
class NetAppCollectorAttribute(CollectorAttribute):
    ...
    def __init__(self, name=None, ip=None, net_app_api=None, net_app_aggregate=None, net_app_index=None, net_app_instance=None, net_app_object=None, net_app_type=None, net_app_xml=None, net_app_xml_bulk=None, net_app_xml_bulk_locator=None, net_app_xml_index=None, net_app_xml_instance=None, net_app_xml_locator=None, params=None):  # noqa: E501
