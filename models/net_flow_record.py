...
class NetFlowRecord(object):
    ...
    def __init__(self, data_type=None, destination_m_bytes=None, dst_dns=None, dst_ip=None, dst_port=None, first_epoch_in_sec=None, if_in=None, if_out=None, last_epoch_in_sec=None, percent_usage=None, protocol=None, source_m_bytes=None, src_dns=None, src_ip=None, src_port=None, usage=None):  # noqa: E501
