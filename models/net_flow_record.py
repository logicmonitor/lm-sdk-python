...
class NetFlowRecord(object):
    ...
    def __init__(self, src_ip=None, percent_usage=None, last_epoch_in_sec=None, if_out=None, data_type=None, usage=None, dst_dns=None, src_port=None, first_epoch_in_sec=None, protocol=None, dst_port=None, if_in=None, source_m_bytes=None, src_dns=None, destination_m_bytes=None, dst_ip=None):  # noqa: E501
