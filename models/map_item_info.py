...
class MapItemInfo(object):
    ...
    def __init__(self, active_status=None, alert_status=None, description=None, display_name=None, formatted_location=None, id=None, latitude=None, location=None, longitude=None, name=None, sdt_status=None, sub_type=None, type=None):  # noqa: E501
