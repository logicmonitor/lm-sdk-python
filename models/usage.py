...
class Usage(object):
    ...
    def __init__(self, num_of_aws_devices=None, num_of_azure_devices=None, num_of_combined_aws_devices=None, num_of_combined_azure_devices=None, num_of_combined_gcp_devices=None, num_of_config_source_devices=None, num_of_gcp_devices=None, num_of_services=None, num_of_stopped_aws_devices=None, num_of_stopped_azure_devices=None, num_of_stopped_gcp_devices=None, num_of_terminated_aws_devices=None, num_of_terminated_azure_devices=None, num_of_terminated_gcp_cloud_devices=None, num_of_websites=None, number_of_devices=None, number_of_kubernetes_devices=None, number_of_standard_devices=None):  # noqa: E501
