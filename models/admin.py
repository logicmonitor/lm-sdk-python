...
class Admin(object):
    ...
    def __init__(self, accept_eula=None, accept_eula_on=None, api_tokens=None, apionly=None, contact_method=None, created_by=None, email=None, first_name=None, force_password_change=None, id=None, last_action=None, last_action_on=None, last_action_on_local=None, last_login_on=None, last_name=None, note=None, password=None, phone=None, roles=None, sms_email=None, sms_email_format=None, status=None, timezone=None, training_email=None, two_fa_enabled=None, username=None, view_permission=None):  # noqa: E501
