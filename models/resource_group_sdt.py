...
class ResourceGroupSDT(SDT):
    ...
    def end_date_time_on_local(self):
        """Gets the end_date_time_on_local of this ResourceGroupSDT.  # noqa: E501

        The date, time and time zone that the SDT will end at  # noqa: E501

        :return: The end_date_time_on_local of this ResourceGroupSDT.  # noqa: E501
        :rtype: str
        """
    ...
    def end_date_time_on_local(self, end_date_time_on_local):
        """Sets the end_date_time_on_local of this ResourceGroupSDT.

        The date, time and time zone that the SDT will end at  # noqa: E501

        :param end_date_time_on_local: The end_date_time_on_local of this ResourceGroupSDT.  # noqa: E501
        :type: str
        """
    ...
    @property
    def timezone(self):
        """Gets the timezone of this ResourceGroupSDT.  # noqa: E501

        The specific timezone for SDT  # noqa: E501

        :return: The timezone of this ResourceGroupSDT.  # noqa: E501
        :rtype: str
        """
    ...
    def timezone(self, timezone):
        """Sets the timezone of this ResourceGroupSDT.

        The specific timezone for SDT  # noqa: E501

        :param timezone: The timezone of this ResourceGroupSDT.  # noqa: E501
        :type: str
        """
    ...
    @property
    def sdt_type(self):
        """Gets the sdt_type of this ResourceGroupSDT.  # noqa: E501

        The type of sdt. The values can be oneTime|weekly|monthly|daily|monthlyByWeek  # noqa: E501

        :return: The sdt_type of this ResourceGroupSDT.  # noqa: E501
        :rtype: str
        """
    ...
    def sdt_type(self, sdt_type):
        """Sets the sdt_type of this ResourceGroupSDT.

        The type of sdt. The values can be oneTime|weekly|monthly|daily|monthlyByWeek  # noqa: E501

        :param sdt_type: The sdt_type of this ResourceGroupSDT.  # noqa: E501
        :type: str
        """
    ...
    def month_day(self, month_day):
        """Sets the month_day of this ResourceGroupSDT.

        The values can be 1 | 2....| 31. Specifies the day of the month that the SDT will be active for a monthly SDT  # noqa: E501

        :param month_day: The month_day of this ResourceGroupSDT.  # noqa: E501
        :type: int
        """
    ...
    def week_of_month(self):
        """Gets the week_of_month of this ResourceGroupSDT.  # noqa: E501

        The week of the month that the SDT will be active for a monthly SDT  # noqa: E501

        :return: The week_of_month of this ResourceGroupSDT.  # noqa: E501
        :rtype: str
        """
    ...
    def week_of_month(self, week_of_month):
        """Sets the week_of_month of this ResourceGroupSDT.

        The week of the month that the SDT will be active for a monthly SDT  # noqa: E501

        :param week_of_month: The week_of_month of this ResourceGroupSDT.  # noqa: E501
        :type: str
        """
    ...
    @property
    def admin(self):
        """Gets the admin of this ResourceGroupSDT.  # noqa: E501

        The name of the user that created the SDT  # noqa: E501

        :return: The admin of this ResourceGroupSDT.  # noqa: E501
        :rtype: str
        """
        return self._admin
    ...
    def admin(self, admin):
        """Sets the admin of this ResourceGroupSDT.

        The name of the user that created the SDT  # noqa: E501

        :param admin: The admin of this ResourceGroupSDT.  # noqa: E501
        :type: str
        """
    ...
    def end_date_time(self):
        """Gets the end_date_time of this ResourceGroupSDT.  # noqa: E501

        The epoch time, in milliseconds, that the SDT will end  # noqa: E501

        :return: The end_date_time of this ResourceGroupSDT.  # noqa: E501
        :rtype: int
        """
    ...
    def end_date_time(self, end_date_time):
        """Sets the end_date_time of this ResourceGroupSDT.

        The epoch time, in milliseconds, that the SDT will end  # noqa: E501

        :param end_date_time: The end_date_time of this ResourceGroupSDT.  # noqa: E501
        :type: int
        """
    ...
    @property
    def type(self):
        """Gets the type of this ResourceGroupSDT.  # noqa: E501
        ...
        :return: The type of this ResourceGroupSDT.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ResourceGroupSDT.

        The type of resource that this SDT is for. The values can be CollectorSDT | DeviceDataSourceInstanceSDT | DeviceBatchJobSDT | DeviceClusterAlertDefSDT | DeviceDataSourceInstanceGroupSDT | DeviceDataSourceSDT | DeviceEventSourceSDT | ResourceGroupSDT | ResourceSDT | WebsiteCheckpointSDT | WebsiteGroupSDT | WebsiteSDT | DeviceLogPipeLineResourceSDT  # noqa: E501

        :param type: The type of this ResourceGroupSDT.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    def is_effective(self):
        """Gets the is_effective of this ResourceGroupSDT.  # noqa: E501

        The values can be true|false, where true: the SDT is currently active false: the SDT is currently inactive  # noqa: E501

        :return: The is_effective of this ResourceGroupSDT.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_effective(self, is_effective):
        """Sets the is_effective of this ResourceGroupSDT.

        The values can be true|false, where true: the SDT is currently active false: the SDT is currently inactive  # noqa: E501

        :param is_effective: The is_effective of this ResourceGroupSDT.  # noqa: E501
        :type: bool
        """
    ...
    def minute(self, minute):
        """Sets the minute of this ResourceGroupSDT.

        The values can be 1 | 2....| 60. Specifies the minute of the hour that the SDT should begin for a repeating SDT  # noqa: E501

        :param minute: The minute of this ResourceGroupSDT.  # noqa: E501
        :type: int
        """
    ...
    @property
    def duration(self):
        """Gets the duration of this ResourceGroupSDT.  # noqa: E501

        The duration of the SDT in minutes  # noqa: E501

        :return: The duration of this ResourceGroupSDT.  # noqa: E501
        :rtype: int
        """
    ...
    def duration(self, duration):
        """Sets the duration of this ResourceGroupSDT.

        The duration of the SDT in minutes  # noqa: E501

        :param duration: The duration of this ResourceGroupSDT.  # noqa: E501
        :type: int
        """
    ...
    @property
    def end_hour(self):
        """Gets the end_hour of this ResourceGroupSDT.  # noqa: E501

        The values can be 1 | 2....| 24. Specifies the hour that the SDT ends for a repeating SDT  # noqa: E501

        :return: The end_hour of this ResourceGroupSDT.  # noqa: E501
        :rtype: int
        """
    ...
    def end_hour(self, end_hour):
        """Sets the end_hour of this ResourceGroupSDT.

        The values can be 1 | 2....| 24. Specifies the hour that the SDT ends for a repeating SDT  # noqa: E501

        :param end_hour: The end_hour of this ResourceGroupSDT.  # noqa: E501
        :type: int
        """
    ...
    def start_date_time(self):
        """Gets the start_date_time of this ResourceGroupSDT.  # noqa: E501

        The epoch time, in milliseconds, that the SDT will start  # noqa: E501

        :return: The start_date_time of this ResourceGroupSDT.  # noqa: E501
        :rtype: int
        """
    ...
    def start_date_time(self, start_date_time):
        """Sets the start_date_time of this ResourceGroupSDT.

        The epoch time, in milliseconds, that the SDT will start  # noqa: E501

        :param start_date_time: The start_date_time of this ResourceGroupSDT.  # noqa: E501
        :type: int
        """
    ...
    @property
    def hour(self):
        """Gets the hour of this ResourceGroupSDT.  # noqa: E501
        ...
        :return: The hour of this ResourceGroupSDT.  # noqa: E501
        :rtype: int
        """
        return self._hour
    ...
    @hour.setter
    def hour(self, hour):
        """Sets the hour of this ResourceGroupSDT.

        The values can be 1 | 2....| 24. Specifies the hour that the SDT will start for a repeating SDT (daily, weekly, or monthly)  # noqa: E501

        :param hour: The hour of this ResourceGroupSDT.  # noqa: E501
        :type: int
        """
    ...
    def start_date_time_on_local(self):
        """Gets the start_date_time_on_local of this ResourceGroupSDT.  # noqa: E501

        The date, time and time zone that the SDT will end at  # noqa: E501

        :return: The start_date_time_on_local of this ResourceGroupSDT.  # noqa: E501
        :rtype: str
        """
    ...
    def start_date_time_on_local(self, start_date_time_on_local):
        """Sets the start_date_time_on_local of this ResourceGroupSDT.

        The date, time and time zone that the SDT will end at  # noqa: E501

        :param start_date_time_on_local: The start_date_time_on_local of this ResourceGroupSDT.  # noqa: E501
        :type: str
        """
    ...
    @property
    def week_day(self):
        """Gets the week_day of this ResourceGroupSDT.  # noqa: E501

        The week day of sdt. The values can be SUNDAY|MONDAY|TUESDAY|WEDNESDAY|THURSDAY|FRIDAY|SATURDAY  # noqa: E501

        :return: The week_day of this ResourceGroupSDT.  # noqa: E501
        :rtype: str
        """
    ...
    def week_day(self, week_day):
        """Sets the week_day of this ResourceGroupSDT.

        The week day of sdt. The values can be SUNDAY|MONDAY|TUESDAY|WEDNESDAY|THURSDAY|FRIDAY|SATURDAY  # noqa: E501

        :param week_day: The week_day of this ResourceGroupSDT.  # noqa: E501
        :type: str
        """
    ...
    @property
    def comment(self):
        """Gets the comment of this ResourceGroupSDT.  # noqa: E501

        The notes associated with the SDT  # noqa: E501

        :return: The comment of this ResourceGroupSDT.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this ResourceGroupSDT.

        The notes associated with the SDT  # noqa: E501

        :param comment: The comment of this ResourceGroupSDT.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this ResourceGroupSDT.  # noqa: E501
        ...
        :return: The id of this ResourceGroupSDT.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ResourceGroupSDT.

        The Id of the SDT. This value will be in the following format \"XX_##\" where XX will refer to the type of SDT and ## will refer to the number of SDTs of that type  # noqa: E501

        :param id: The id of this ResourceGroupSDT.  # noqa: E501
        :type: str
        """
    ...
    @property
    def end_minute(self):
        """Gets the end_minute of this ResourceGroupSDT.  # noqa: E501

        The values can be 1 | 2....| 60. Specifies the minute of the hour that the SDT ends for a repeating SDT  # noqa: E501

        :return: The end_minute of this ResourceGroupSDT.  # noqa: E501
        :rtype: int
        """
    ...
    def end_minute(self, end_minute):
        """Sets the end_minute of this ResourceGroupSDT.

        The values can be 1 | 2....| 60. Specifies the minute of the hour that the SDT ends for a repeating SDT  # noqa: E501

        :param end_minute: The end_minute of this ResourceGroupSDT.  # noqa: E501
        :type: int
        """
