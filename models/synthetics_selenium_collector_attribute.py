...
class SyntheticsSeleniumCollectorAttribute(CollectorAttribute):
    ...
    def __init__(self, name=None, check_type=None, configs=None, synthetic_script=None):  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this SyntheticsSeleniumCollectorAttribute.  # noqa: E501

        data collector's name  # noqa: E501

        :return: The name of this SyntheticsSeleniumCollectorAttribute.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SyntheticsSeleniumCollectorAttribute.

        data collector's name  # noqa: E501

        :param name: The name of this SyntheticsSeleniumCollectorAttribute.  # noqa: E501
        :type: str
        """
        if name is None:
