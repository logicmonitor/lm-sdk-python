...
**use_default_root** | **bool** | The values can be true|false Check if using the default root | [optional] 
...
**enable** | **bool** | The values can be true|false Specifies whether to enable step or not | [optional] 
...
**follow_redirection** | **bool** | The values can be true|false Specifies whether to follow redirection or not | [optional] 
