...
------------ | ------------- | ------------- | -------------
**sdt_ids** | **str** | The SDT Ids associated with the alert | [optional] 
...
**sdted** | **object** | It specifies if the SDT is set for an active alert or not. However, the sdted is set to false for cleared alert as you cannot apply SDT to a cleared alert. | [optional] 
...
**last_updated_on_epoch** | **int** | The time (in epoch format) that the alert was last updated. This field is used to track the most recent update to the alert, such as changes in its state, acknowledgment, or other properties | [optional] 
...
**clear_expr** | **str** | Specified log alert clear expression information | [optional] 
...
**alert_query** | **str** | Specified alert query information | [optional] 
...
**session_id** | **int** | The session id of alert | [optional] 
