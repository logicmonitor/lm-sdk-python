...
**contact** | **str** | Contact details, email address or phone number | 
**type** | **str** | The recipient type.  The values can be GROUP|ARBITRARY|ADMIN, where Admin &#x3D; a user, and Arbitrary &#x3D; an arbitrary email | 
**addr** | **str** | The recipient address.  The value will be user name if method &#x3D; admin, or the email address if method &#x3D; arbitrary | 
