...
**month_day** | **str** | The values can be -3 | 1 | 2....| 31. Specifies the day(s) of the month that the SDT will be active for a monthly SDT. Use -3 for the last day of the month. Supports comma-separated values (e.g., &#x27;1,15,28&#x27;) when multi-day is enabled. | [optional] 
...
**week_day** | **str** | The week day of sdt. For weekly &amp; monthlyByWeek SDT, supports comma-separated values like &#x27;Monday,Friday&#x27;. Values can be SUNDAY|MONDAY|TUESDAY|WEDNESDAY|THURSDAY|FRIDAY|SATURDAY | [optional] 
