...
**exclude100_availability** | **bool** | Whether or not Uptimes with 100% availability should be ignored | [optional] 
**display_type** | **int** | 1 | 2 1: Display overall locations 2: Display overall and individual locations | [optional] 
**exclude_sdt** | **bool** | Whether or not SDTs periods should be considered for the Uptime&#x27;s availability | [optional] 
...
**items_type** | **str** | The type of entities specified in the servicesVal field. Acceptable values are: uptime resource, group | 
**items** | **str** | The uptime resource OR uptime resource groups (full path) selected for the report, where multiple entities are separated by commas | [optional] 
