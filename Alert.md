...
**suppressor** | **str** | The component (Ex SDT, HostClusterAlert) which suppressed the alert | [optional] 
...
**ad_alert** | **bool** | Whether or not the alert is dynamic threshold based | [optional] 
